...
export default function ArticleContent() {
    return (
        <div className = "article">
            ...
            <p>
                An image like that just can&rsquo;t be faked with current technology, so these words must have come right from the Former President himself. Now, let's just examine the counter-evidence because how could I post this without even acknowledging the other side? I am a proponent of well-evidenced and thorough argumentation, after all.
            </p>
            <p>
                First of all, some proclaim that photographs taken by NASA that depict a round Earth are hard proof of their argument. How <span className = "emphasized">na&iuml;ve</span>. Image forgery technology has advanced by leaps and bounds in the last few years, so producing a high-resolution image of a round Earth is now trivial for an organization with as much funding as NASA. Why should we blindly put our faith in these images from sources we don&rsquo;t know and which are plastered all over websites we don&rsquo;t trust?
            </p>
            <p>
                Another piece of &ldquo;evidence&rdquo; among flat earth deniers is the tale of the blogger Kayleigh Williams. In an attempt to determine the geometry of the Earth once and for all, Williams decided to journey across the entirety of the Earth&rsquo;s equator and film the whole trip. She reasoned that if she returned to the same location after traversing the equator, the Earth must be a sphere. While she did claim in a follow-up blog post that she ended up returning to the same spot (with a video that seemed to corroborate the story), there&rsquo;s a <span className = "emphasized">simple explanation</span> for all this.
            </p>
            <p>
                It's clear that the United States government has stationed military personnel and NASA employees along the edge of the Earth to prevent any inquisitive souls like Williams from discovering the truth. Once Williams reached the edge, she must've been apprehended by these guards and tranquilized. At this point, she was rushed to the other side of the flat Earth using an underground network of high-speed transportation tunnels, build by the government and concealed from the people. Her memories of the ordeal were erased using experimental government mind-control drugs and the video footage was doctored to create the illusion of a smooth transition between locations. Williams was released to continue the remainder of her journey, and after reaching the location where she started, she concluded that the Earth was spherical. To the public, this story simply confirmed what they already "knew" and was of little note, so the tale largely faded away... just what the government wanted. The public (and Williams) were none the wiser to any of this deception, and the widespread belief in the round Earth remained unchallenged.
            </p>
            <p>
                That is, until now. Now, you know the truth. Now, you know that our government &ndash; which is sworn by the Constitution to protect us, the people &ndash; is conspiring to keep the public in the dark. Now, you know what lies behind the veil the government has so carefully crafted to blind you. At least, you should. If you <em>still</em> refuse to accept that the Earth is flat, don&rsquo;t even try emailing to convince me. Nothing can change my mind: <span className = "emphasized">I already know I&rsquo;m right</span>.
            </p>
            <hr />
